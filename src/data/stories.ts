...
maybe you can still hear the sleds coming through the snow toward Kolhuset. ✨`,
  ...
  },
  {
    ...
    language: "en",
    ageGroups: ["adult"],
    title: "Genk Discovery Point",
    subtitle: "C-Mine Area",
    location: { ...LOCATIONS.GENK_POINT_1, label: "Genk Point 1" },
    audio: "",
    emoji: "📍",
    accent: "moss",
    text: "Welcome to Genk, a city shaped by industry and nature.\n\nThis test story marks the first discovery point.\n\nLook around — what do you notice?\nThe streets, the buildings, the sky.\n\nEvery place has a story waiting to be heard.",
    mission: [
      "Look around and name three things you see",
      "Listen for a sound you haven't noticed before",
      "Take a photo of something interesting",
    ],
    reward: "Genk Explorer",
  },
  {
    id: "genk_test_2",
    villageId: "genk",
    language: "en",
    ageGroups: ["adult"],
    title: "Genk Second Marker",
    subtitle: "City Center",
    location: { ...LOCATIONS.GENK_POINT_2, label: "Genk Point 2" },
    audio: "",
    emoji: "📍",
    accent: "ember",
    text: "You found the second spot in Genk.\n\nThis is a test story to help verify that locations, proximity, and story unlocking all work correctly.\n\nIf you're reading this, the system is working.",
    mission: [
      "Confirm you can see this text",
      "Check the compass points here from a distance",

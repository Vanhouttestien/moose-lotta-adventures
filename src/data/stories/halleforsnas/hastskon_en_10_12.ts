...
export const hastskon_en_10_12: Story = {
  id: "hastskon_en_10_12",
  villageId: "halleforsnas",
  language: "en",
  ageGroups: ["10-12"],
  title: "Hästskon: 170 Years of Change",
...
`,
  mission: [
    ...
    "Discuss: should old buildings always be saved?",
  ],
  reward: "Time Traveller",
};
